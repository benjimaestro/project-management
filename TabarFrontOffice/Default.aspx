...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApplyCarColour" runat="server" style="z-index: 1; left: 200px; top: 398px; position: absolute" Text="APPLY" OnClick="btnApplyCarColour_Click" />
        ...
        <asp:Button ID="btnApplyCarMake" runat="server" style="z-index: 1; left: 200px; top: 471px; position: absolute" Text="APPLY" OnClick="btnApplyCarMake_Click" />
        ...
        <asp:Button ID="btnApplyCarModel" runat="server" style="z-index: 1; left: 200px; top: 545px; position: absolute; " Text="APPLY" OnClick="btnApplyCarModel_Click" />
        ...
        <asp:Button ID="btnStaff" runat="server" style="z-index: 1; left: 192px; top: 228px; position: absolute" Text="MANAGE CUSTOMERS" OnClick="btnStaff_Click" />
