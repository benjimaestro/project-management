...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 185px; top: 35px; position: absolute; width: 71px" Text="ADD" />
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 186px; top: 76px; position: absolute; width: 70px" Text="EDIT" />
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 185px; top: 116px; position: absolute" Text="DELETE" />
        ...
        <asp:Button ID="btnApplyCarColour" runat="server" style="z-index: 1; left: 156px; top: 398px; position: absolute" Text="APPLY" />
